...
pub const __declspec = @compileError("unable to translate C expr: unexpected token '__attribute__'"); // (no file):424:9
pub const _cdecl = @compileError("unable to translate macro: undefined identifier `__cdecl__`"); // (no file):425:9
pub const __cdecl = @compileError("unable to translate macro: undefined identifier `__cdecl__`"); // (no file):426:9
pub const _stdcall = @compileError("unable to translate macro: undefined identifier `__stdcall__`"); // (no file):427:9
pub const __stdcall = @compileError("unable to translate macro: undefined identifier `__stdcall__`"); // (no file):428:9
pub const _fastcall = @compileError("unable to translate macro: undefined identifier `__fastcall__`"); // (no file):429:9
pub const __fastcall = @compileError("unable to translate macro: undefined identifier `__fastcall__`"); // (no file):430:9
pub const _thiscall = @compileError("unable to translate macro: undefined identifier `__thiscall__`"); // (no file):431:9
pub const __thiscall = @compileError("unable to translate macro: undefined identifier `__thiscall__`"); // (no file):432:9
pub const _pascal = @compileError("unable to translate macro: undefined identifier `__pascal__`"); // (no file):433:9
pub const __pascal = @compileError("unable to translate macro: undefined identifier `__pascal__`"); // (no file):434:9
pub const va_start = @compileError("unable to translate macro: undefined identifier `__builtin_va_start`"); // D:\Users\e.vallot\AppData\Roaming\Code\User\globalStorage\ziglang.vscode-zig\zig_install\lib\include/stdarg.h:33:9
pub const va_end = @compileError("unable to translate macro: undefined identifier `__builtin_va_end`"); // D:\Users\e.vallot\AppData\Roaming\Code\User\globalStorage\ziglang.vscode-zig\zig_install\lib\include/stdarg.h:35:9
pub const va_arg = @compileError("unable to translate C expr: unexpected token 'an identifier'"); // D:\Users\e.vallot\AppData\Roaming\Code\User\globalStorage\ziglang.vscode-zig\zig_install\lib\include/stdarg.h:36:9
pub const __va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`"); // D:\Users\e.vallot\AppData\Roaming\Code\User\globalStorage\ziglang.vscode-zig\zig_install\lib\include/stdarg.h:41:9
pub const va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`"); // D:\Users\e.vallot\AppData\Roaming\Code\User\globalStorage\ziglang.vscode-zig\zig_install\lib\include/stdarg.h:46:9
pub const RL_MALLOC = @compileError("unable to translate macro: undefined identifier `malloc`"); // D:\Users\e.vallot\Desktop\zframe\lib\raylib\include/raylib.h:122:13
pub const RL_CALLOC = @compileError("unable to translate macro: undefined identifier `calloc`"); // D:\Users\e.vallot\Desktop\zframe\lib\raylib\include/raylib.h:125:13
pub const RL_REALLOC = @compileError("unable to translate macro: undefined identifier `realloc`"); // D:\Users\e.vallot\Desktop\zframe\lib\raylib\include/raylib.h:128:13
pub const RL_FREE = @compileError("unable to translate macro: undefined identifier `free`"); // D:\Users\e.vallot\Desktop\zframe\lib\raylib\include/raylib.h:131:13
